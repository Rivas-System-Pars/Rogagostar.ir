<div
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{ url('/') }}" target="_blank">
                    <h2 class="brand-text mb-0">{{ option('info_site_title', 'داستار') }}</h2>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <ul class="menu-content">
                        @can('posts.index')
                            <li class="{{ active_class('admin.posts.index') }}">
                                <a href="{{ route('admin.posts.index') }}"><i class="feather icon-circle"></i><span
                        ...
                        @can('posts.create')
                            <li class="{{ active_class('admin.posts.create') }}">
                                <a href="{{ route('admin.posts.create') }}"><i class="feather icon-circle"></i><span
                    ...
                    <ul class="menu-content">
                        ...
                        @can('products.spectypes')
                            <li class="{{ active_class('admin.spectypes.index') }}">
                                <a href="{{ route('admin.spectypes.index') }}"><i class="feather icon-circle"></i><span
                        ...
                        @can('attributes')
                            <li class="{{ open_class(['admin.attributeGroups.*']) }}">
                                <a href="#"><i class="feather icon-circle"></i><span class="menu-item"> ویژگی
                                        ها</span></a>
                                <ul class="menu-content">
                        ...
                        @can('filters')
                            <li class="{{ open_class(['admin.filters.*']) }}">
                                <a href="#"><i class="feather icon-circle"></i><span class="menu-item">
                                        فیلترها</span></a>
                                <ul class="menu-content">
                                    @can('filters.index')
                        ...
                        @can('orders.index')
                            <li class="">
                                <a href="{{ route('admin.orders.index') }}?status=paid&shipping_status=pending"><i
                                        class="feather icon-circle"></i><span class="menu-item">سفارشات جدید</span></a>
                            </li>
                        @endcan
            ...
            @can('carriers')
                <li
                    class="nav-item has-sub {{ open_class(['admin.provinces.*', 'admin.carriers.*', 'admin.tariffs.*']) }}">
                    <a href="#"><i class="feather icon-package"></i><span class="menu-title"> حمل و نقل</span></a>
                    <ul class="menu-content">
                    ...
                    <ul class="menu-content">
                        @can('links.index')
                            <li class="{{ active_class('admin.links.index') }}">
                                <a href="{{ route('admin.links.index') }}"><i class="feather icon-circle"></i><span
                        ...
                        @can('links.create')
                            <li class="{{ active_class('admin.links.create') }}">
                                <a href="{{ route('admin.links.create') }}"><i class="feather icon-circle"></i><span
                    ...
                    <ul class="menu-content">
                        @can('pages.index')
                            <li class="{{ active_class('admin.pages.index') }}">
                                <a href="{{ route('admin.pages.index') }}"><i class="feather icon-circle"></i><span
                        ...
                        @can('pages.create')
                            <li class="{{ active_class('admin.pages.create') }}">
                                <a href="{{ route('admin.pages.create') }}"><i class="feather icon-circle"></i><span
                    ...
                    <ul class="menu-content">
                        ...
                        @can('statistics.views')
                            <li class="{{ active_class('admin.statistics.views') }}">
                                <a href="{{ route('admin.statistics.views') }}"><i class="feather icon-circle"></i><span
                    ...
                    <ul class="menu-content">
                        @can('themes.index')
                            <li class="{{ active_class('admin.themes.index') }}">
                                <a href="{{ route('admin.themes.index') }}"><i class="feather icon-circle"></i><span
                            ...
                            @if (config('front.home-widgets'))
                                <li class="{{ active_class('admin.widgets.index') }}">
                                    <a href="{{ route('admin.widgets.index') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item">مدیریت صفحه
                                            اصلی</span></a>
                                </li>
                            @endif
                        @endcan
			...
			@endcan
			@can('sales-agency')
			<li class="{{ active_class('admin.sales-agency.*') }} nav-item"><a href="{{ route('admin.sales-agency.index') }}">
                    <i class="feather icon-map-pin"></i>
                    <span class="menu-title">درخواست نمایندگی فروش</span>
                </a>
            </li>
			@endcan
			@can('demo-request')
			<li class="{{ active_class('admin.CustomerClub.*') }} nav-item"><a href="{{ route('admin.CustomerClub.index') }}">
                    <i class="feather icon-airplay"></i>
                    <span class="menu-title">باشگاه مجریان</span>
                </a>
            </li>
			@endcan
			@can('counseling-form')
			<li class="{{ active_class('admin.counseling-form.*') }} nav-item"><a href="{{ route('admin.counseling-form.index') }}">
                    <i class="feather icon-sunrise"></i>
                    <span class="menu-title">مشاهده فرم خانواده مهندسین</span>
                </a>
            </li>
			@endcan
