...
use Themes\DefaultTheme\src\Controllers\CustomerClubController;
use Themes\DefaultTheme\src\Controllers\CounselingFormController;
use Themes\DefaultTheme\src\Controllers\FamillyCardController;
...
Route::group(['as' => 'front.'], function () {
    ...
    Route::get('/familly-card', [FamillyCardController::class, 'index'])->name('familly-card.index');
    Route::post('/familly-card/store', [FamillyCardController::class, 'store'])->name('familly_card.store');
	...
	Route::get('/customer-club', [CustomerClubController::class, 'index'])->name('CustomerClub.index');
	Route::post('/customer-club', [CustomerClubController::class, 'store'])->name('CustomerClub.store');
