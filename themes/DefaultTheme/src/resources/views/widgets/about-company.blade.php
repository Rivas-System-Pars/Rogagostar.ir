    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 order-md-1 text-right col-12 px-4 d-flex align-items-center justify-content-center">
            <div class="AboutCompany-text-container">
                <div class="AboutCompany-text-section px-md-2 px-xl-0">
                    <p>
...
<div class="container AboutCompany-container pt-4 pt-lg-5" data-aos="fade-up" data-aos-duration="1000">
    <div class="Option_Card_Title mb-5">
        ...
        <h2 class="Option_Card_Center_Line">کنترل کیفی</h2>
    ...
    <div class="row align-items-center flex-row-reverse">
        ...
        <div class="col-md-6 order-md-1 text-right col-12 px-4 d-flex align-items-center justify-content-center">
            <div class="AboutCompany-text-container">
                <div class="AboutCompany-text-section px-md-2 px-xl-0">
                    <p>
                        بخش کنترل کیفیت روگا گستر جهت پیشبرد اهداف کیفی به برنامه ریزی و اجرای برنامه های تدوین شده برای تحقق نیازمندی های فنی و کیفی، الزامات قانونی و استانداردهای ملی و بین المللی و همچنین برآورده ساختن خواسته های کیفی مشتریان می  پردازد. این واحد با نظارت دقیق بر مراحل تولید و انجام تست های لازم بر روی مواد اولیه و محصولات سعی دارد تا محصولی با شاخص های کیفی بالا به مشتریان ارائه نماید.  

کنترل کیفیت در 3 مرحله ی: کنترل مواد اولیه ، کنترل حین تولید و  کنترل محصول نهایی به اجرا در می آید. 
                    </p>
                </div>
            </div>
        </div>
