...
class MainController extends Controller
{
    ...
    {
        // $date_widget = WidgetOption::where('widget_id',43)->where('key','end_date')->first();
        // $time_widget = WidgetOption::where('widget_id',43)->where('key','end_time')->first();

        $date_time = [
            'date_widget'   => WidgetOption::where('widget_id',43)->where('key','end_date')->first()->value,
            'time_widget'   => WidgetOption::where('widget_id',43)->where('key','end_time')->first()->value,
        ];
